...
## 📦 Installing the extension form (v6.5)

- **Recommended**: `chrome://extensions` → enable Developer mode → "Load unpacked" → pick the
  `extension/` directory (generated by `node scripts/build-extension.js`).
